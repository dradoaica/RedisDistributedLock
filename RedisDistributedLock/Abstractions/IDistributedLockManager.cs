...
public interface IDistributedLockManager
{
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>
    ///     A hint used for determining the next time delay in calling Renew.
    ///     True means the next execution should occur at a normal delay. False means the next execution should occur quickly;
    ///     use this in network error cases.
    /// </returns>
    /// <remarks>
